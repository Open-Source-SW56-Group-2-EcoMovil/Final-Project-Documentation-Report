...
|----|----|----|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Calisaya Sánchez, Juan Jesús**<br>*TB1*<br></br>**Gallo Quintana, David Ivanoff**<br>*TB1*<br> He desarrollado distintas partes del proyecto, incluyendo la elaboración de User Personas, User Task Matrix, User Journey Mapping. Ademas de esto apoye en la realización de entrevistas en este caso hacia el segmento rentador. Finalmente participe en la elaboración del landing page, tanto en sus wireframes, mock-ups, asi como en su despliegue. </br>**Hidalgo Lopez, Mathias Adriano**<br>*TB1*<br></br>**Oneglio De Paz, Beth Shantal**<br>*TB1*<br>He desarrollado y refinado varios aspectos clave para el proyecto, incluyendo la elaboración de las hipótesis Lean UX y el Lean UX Canvas. Además, he identificado los segmentos objetivos y competidores, y realicé un análisis competitivo. Conduje una entrevista a un segmento específico y analicé los resultados obtenidos. Finalmente, avancé significativamente en la creación de las directrices de estilo ("Style Guidelines"), abarcando áreas como las pautas generales de estilo, directrices para la web, arquitectura de la información y sistemas de organización, lo que nos prepara para comenzar a trabajar en la landing page con mi equipo.<br>**Vasquez Goicochea, Erick Alessander**<br>*TB1*<br> |  |
| Comunica por escrito con efectividad a diferentes rangos de audiencia. | **Calisaya Sánchez, Juan Jesús**<br>*TB1*<br> </br>**Gallo Quintana, David Ivanoff**<br>*TB1*<br> Como grupo, consideramos que realizamos las ideas dadas eran tanto plausibles para nosotros como equipo como efectivas hacia los usuarios potenciales. Después de asegurarnos que estas consideraciones se cumplieran, coincidimos tanto en diseño UX/UI en la elaboración de la landing page, además de esto pasamos por varios diseños para llegar al más convincente en cuestión de web app design. </br>**Hidalgo Lopez, Mathias Adriano**<br>*TB1*<br> <br>**Oneglio De Paz, Beth Shantal**<br>*TB1*<br>Al iniciar el trabajo, nos reunimos para revisar los usuarios y asegurar que nuestra idea y misión estuvieran bien definidas. Una vez que plasmamos nuestro objetivo en un documento de Word, comenzamos con reuniones semanales para avanzar en las entrevistas y llevar un seguimiento detallado de los capítulos. Durante la creación de la landing page, compartimos ideas y diseños con ejemplos para garantizar un desarrollo futuro más organizado.<br>**Vasquez Goicochea, Erick Alessander**<br>*TB1*<br>|  |
